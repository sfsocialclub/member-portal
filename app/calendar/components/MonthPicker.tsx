...
import { formatDateToMonthAndYear } from "@/lib/util/dateFormatters";
        ...
        <>
            <div className="flex flex-col items-center gap-y-2 w-full">
                <div className="flex items-center gap-x-2 w-full">
                    <p className="text-xl font-[Dm_Sans_Variable] font-semibold mr-auto">{formatDateToMonthAndYear(year, month)} Events</p>
                ...
                <p className="text-xs w-full italic">All events are shown in Pacific</p>
            </div>
        </>
    )
}